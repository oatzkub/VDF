...
namespace VDF.GUI.ViewModels {
	public sealed class ExpressionBuilderVM : ReactiveObject {
		...
		public ExpressionBuilderVM(ExpressionBuilder Host) {
			...
			sb.AppendLine($"Example: Path.GetFileNameWithoutExtension(item.{nameof(DuplicateItem.Path)}).Contains(\"a2\")");
			...
			sb.AppendLine("Available static helpers: TimeSpan, Math, Path, Regex");
